    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {charities?.map((charity) => (
          <div key={charity.id} className="p-6 rounded-2xl bg-zinc-900/50 border border-white/10 group relative transition-all hover:border-white/20">
            ...
            <h3 className="text-lg font-medium">{charity.name}</h3>
